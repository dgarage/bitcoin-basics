...
const static unsigned int SHA256_INITIAL_HASH[8] = {
...
#define sigma0(x) (ROTR_32(x, 7) ^ ROTR_32(x, 18) ^ SHR(x, 3))

#define sigma1(x) (ROTR_32(x, 17) ^ ROTR_32(x, 19) ^ SHR(x, 10))
...
typedef struct _sha256context
{
    ...
    unsigned int H[SHA256_WORD_SIZE];
